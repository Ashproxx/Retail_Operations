...
- [x] Role definitions and deny-by-default action/store policy
- [x] Server-owned token identity mapping and secret-safe configuration
- [x] Authorization before registered tools and retrieval provider calls
- [x] Document/provenance hashes and standard HMAC verification
- [x] Foundation audit schema plus persisted hash-chain checks and trusted anchors
