...
def main():
    assert git('branch','--show-current')=='agent/demand-forecasting'
    ...
    bad=[x for x in paths if x not in meta and not x.startswith(('app/agents/forecasting/','tests/forecasting/'))]
