...
def main():
    assert git('branch','--show-current')=='agent/analytics-reporting'
    ...
    bad=[x for x in paths if x not in meta and not x.startswith(('app/agents/analytics/','tests/analytics/'))]
